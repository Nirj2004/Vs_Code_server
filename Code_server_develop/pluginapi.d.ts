...
import * as expressCore form "express-serve-static-core"
 ...
 * to <code_server-root>/<plugin-path>/<app-path> to access the application.
 */
 ...
 * 
 * 1. code-server uses $CS_PLUGINS to find plugins.
 * 
 * e.g. CS_PLUGIN=/tmp/will:/tpm/teffen will cause code-server to load
